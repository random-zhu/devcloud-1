  ...
  <div class="wrapper">
    ...
    <div class="box-shadow" style="background-color: #fff">
      ...
      <div class="form-content">
        ...
        <div style="margin-top: 24px">
          ...
          >
            ...
            >
              ...
              <el-radio v-model="profileForm.gender" label="female"
                >女</el-radio
              >
              <el-radio v-model="profileForm.gender" label="unknown"
                >保密</el-radio
              >
            </el-form-item>
            <el-form-item
        ...
        <div>
          <div>
            <el-button :disabled="active === 0" @click="previous"
              >上一步</el-button
            >
...
<script>
import { UPDATE_PROFILE } from "@/api/keyauth/profile";
import { JOIN_DEPARTMENT } from "@/api/keyauth/department";
import ChoiceDepartment from "@/components/ChoiceDepartment";
import Tips from "@/components/Tips";

const tips = ["点击完成后, 加入申请就会提交, 请及时联系部门负责人处理"];
...
export default {
  ...
  methods: {
    ...
    async submit() {
      var upResp = await UPDATE_PROFILE(this.profileForm);
      console.log(upResp);
      var jdResp = await JOIN_DEPARTMENT(this.departForm);
      console.log(jdResp);
      // 调转到首页
