    ...
    <el-row style="margin-top: 18px">
      <el-col :span="2">
        ...
        <span class="attr-value f12" style="margin-left: 12px">
          <span v-if="service.client_enabled"
      ...
      <el-col :span="4">
        ...
        <span
          v-if="service.client_refresh_at"
          class="attr-value f12"
          style="margin-left: 12px"
          >{{
            service.client_refresh_at | parseTime("{y}-{m}-{d} {h}:{i}")
          }}</span
        >
      ...
      <el-col :span="6">
        ...
        <el-button
          v-clipboard:copy="service.client_id"
      ...
      <el-col :span="8">
        ...
        <el-button
          v-clipboard:copy="service.client_secret"
          v-clipboard:success="clipboardSuccess"
          type="text"
          icon="el-icon-document-copy"
          style="padding: 0px; margin-left: 12px"
...
import { REFRESH_SERVICE_CLIENT } from "@/api/keyauth/micro";
...
export default {
  ...
  methods: {
    ...
    async refreshClientSecret() {
      ...
      try {
        let resp = await REFRESH_SERVICE_CLIENT(this.serviceId);
